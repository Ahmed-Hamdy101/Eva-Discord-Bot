...
.setDescription( ` ${member.user} has Joined to  International chat Welcome ${member.user} to International chat !   Be Sure To Check out our  ${member.guild.channels.cache.get(member_channel)} Room  to add your profile ! and Thanks `)
